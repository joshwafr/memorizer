...
#ifndef MEMORIZER_SWIFT_H
#define MEMORIZER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Memorizer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Memorizer12VoiceSession")
@interface VoiceSession : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioPlayer;
@interface VoiceSession (SWIFT_EXTENSION(Memorizer)) <AVAudioPlayerDelegate>
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
@end

@class AVSpeechSynthesizer;
@class AVSpeechUtterance;
@interface VoiceSession (SWIFT_EXTENSION(Memorizer)) <AVSpeechSynthesizerDelegate>
